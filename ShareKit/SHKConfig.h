...
#define SHKFacebookKey				@"1394979517411800"
#define SHKFacebookSecret			@"901f4cd89172a3da140addf1deab9fb3"
 ...
 */
#define SHKTwitterConsumerKey		@"h6N2xMWTOlZ4zyqbT9N06A"
#define SHKTwitterSecret			@"zWt9BI0gYsAFJatbIdWtkfxSDfQ4aF697UFreBnZ8E"
#define SHKTwitterCallbackUrl		@"" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"Super.ae" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
